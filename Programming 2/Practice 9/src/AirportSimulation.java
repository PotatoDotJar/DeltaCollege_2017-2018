...
public class AirportSimulation {
	public static void main(String args[]) {
		final int SIM_TIME = 60 * 10; // 24 hours (in minutes)
		...
		outputReport += "Average wait to land: " + String.format("%8.2f", (double) tot_arr_time / (double) tot_landed)
				+ " minutes" + "\n";
		outputReport += "Average wait to take-off: "
				+ String.format("%8.2f", (double) tot_depart_time / (double) tot_takeoff) + " minutes" + "\n";
