...
/**
   ...
   any size along with the operations transpose, addition, subtraction,
   and multiplication.
...
public class Matrix {
	...
	/**
	 * Constructor: Row and column dimensions passed in as parameters Elements of
	...
	/**
	 * Constructor: Row and column dimensions passed in as parameters Matrix
	 * elements read in from external file (filename passed in). If a problem exists
	 * with the file (i.e. an exception thrown), the processing continues by
	 * initializing matrix elements to zero.
	 * 
	 * @pre File exists and data pattern matches dimensions of matrix
	 * @param filename
	 *            - String containing file name; stored locally
	 * @param rows
	 *            - Number of matrix rows
	 * @param columns
	 *            - Number of matrix columns
	 ...
	 *            - Number of matrix columns
	 * @param newElement
	 *            - New value to update at given position
	 */
	 ...
	 * @param matrix2
	 *            2nd operand in matrix operation
	 */
	public Matrix add(Matrix matrix2) {
		...
		for (int i = 0; i < numberRows; i++)
			for (int j = 0; j < numberCols; j++)
				result.elements[i][j] = elements[i][j] + matrix2.elements[i][j];

		return result;
	}

	/**
	 * Perform matrix subtraction of two available matrix objects.
	 * 
	 * @pre Dimensions of all involved matrices match
	 * @return New matrix object that is the difference of two inputs
	 * @param matrix2
	 *            2nd operand in matrix operation
	 */
		...
		for (int i = 0; i < numberRows; i++)
			for (int j = 0; j < numberCols; j++) {
				...
				for (int k = 0; k < numberCols; k++)
					total += elements[i][k] * matrix2.elements[k][j];
