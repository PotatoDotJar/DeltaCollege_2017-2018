...
public class Contact {
	...
	public boolean matchesBirthDate(int month, int day) {
		if (this.contactBirthDate.getMonth() == month && this.contactBirthDate.getDay() == day)
			return true;
		else
			return false;
	}
	...
	// This method receives a area code. It compares these to the
	// area code of this object and returns true if it matches.
	public boolean matchesAreaCode(int areaCode) {
		if (Integer.parseInt(this.contactAddress.getZip()) == areaCode)
			return true;
		else
			return false;
	}
