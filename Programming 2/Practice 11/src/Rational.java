...
public class Rational implements Comparable<Rational> {
	 ...
	 * 
	 * @param operand2
	 *            Rational object with 2nd operand
	...
	/**
	 * Compares components of two fractions and returns true if the object invoking
	 * the method is arithmetically equal to the parameterized object.
	 * 
	...
	public boolean equals(Object obj) {
		if (obj instanceof Rational) {
			return this.toDecimal() == ((Rational) obj).toDecimal();
		}
		return false;
	}
	 ...
	 * 
	 * @return Integer: 1 if the first is greater than the second, zero if the two
	 *         are equal, and -1 if the first is less than the second.
	 */
