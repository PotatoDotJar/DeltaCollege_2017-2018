...
/**
 * This class manages an unordered list of string objects.  Length of file
...
public class UnorderList {
	 ...
	 * 
	 * @param filename
	 *            string value of local filename containing data
	 */
	 ...
	 * 
	 * @return boolean indicating status of file. True if file loaded OK; false
	 *         otherwise.
	 */
	...
	/**
	 * Delete existing element into the list. If element is not in list, nothing is
	 * done.
	 * 
	 * @param Element
	 *            to be deleted
	...
	/**
	 * This method receives an array of floating point values (double) // sends it
	 * to the output file (declared as constant).
	 *
	...
	/**
	 * Insert an element at front of the list without any regard to the impact to
	 * the order of other elements in the list. List items can end up anywhere as
	 * long as they remain in the list.
	 *
	 * @param newItem
	 *            New list element to be placed at the front
	 */

	public void insertFrontRand(String newItem) {

		// Move existing item to bottom.
		data[numElems] = data[0];
	...
	/**
	 * Insert an element at front of the list while maintaining the given sequence
	 * of the other elements in the list.
	 *
	 * @param newItem
	 *            New list element to be placed at the front
	 */
	public void insertFrontFixed(String newItem) {
		String[] oldDataList = data;

		for (int i = (numElems - 1); i >= 0; i--) {
			data[i + 1] = oldDataList[i];
		}
	...
	/**
	 * Reverse all of the items in the data array.
	 */
	public void reverse() {
		// String[] oldDataList = data;

		// Get the last index.
		int offset = numElems - 1;

		// Loop through first half and replace mirrored half.
